                                    ...
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                         ...
                                         <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                    <label class="login2 pull-right pull-right-pro">Registered User Id</label></div>
<div class="col-lg-7">
<input id="regmob" type="text" name="regmob" required="true" class="form-control" placeholder="Registered User Id">
</div>
</div>
</div>
                                                ...
                                                <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                    <label class="login2 pull-right pull-right-pro">Certificate Id</label></div>
<div class="col-lg-7">
<input id="certificateno" type="text" name="certificateno" required="true" class="form-control" placeholder="Certificate Id">
</div>
</div>
</div>
...
$certificateno=$_POST['certificateno'];
  ?>
  <h4 align="center">Result against Reg Certificate Id. <?php echo $regmob;?> and Certificate no. <?php echo $certificateno;?>  </h4>
